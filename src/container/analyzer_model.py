...
model = joblib.load(current_dir / "classifier_xgb_model.pkl")
encoder = joblib.load(current_dir / "encoderf_xgb.pkl")
feature = joblib.load(current_dir / "features_list.pkl")
